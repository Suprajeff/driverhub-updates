...
import com.deliveryhub.uberwatcher.material.internal.ProvideContentColorTextStyle
import com.deliveryhub.uberwatcher.material.internal.rememberAnimatedShape
import com.deliveryhub.uberwatcher.material.tokens.ButtonSmallTokens
import com.deliveryhub.uberwatcher.material.tokens.MotionSchemeKeyTokens
import com.deliveryhub.uberwatcher.material.tokens.SplitButtonLargeTokens
import com.deliveryhub.uberwatcher.material.tokens.SplitButtonMediumTokens
import com.deliveryhub.uberwatcher.material.tokens.SplitButtonSmallTokens
import com.deliveryhub.uberwatcher.material.tokens.SplitButtonXLargeTokens
import com.deliveryhub.uberwatcher.material.tokens.SplitButtonXSmallTokens
import com.deliveryhub.uberwatcher.material.tokens.StateTokens
...
object SplitButtonDefaults {
    ...
    fun leadingButtonShapesFor(buttonHeight: Dp): SplitButtonShapes {
        val xSmallHeight = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.ExtraSmallContainerHeight
        val smallHeight = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.MinHeight
        val mediumHeight = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.MediumContainerHeight
        val largeHeight = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.LargeContainerHeight
        val xLargeHeight = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.ExtraLargeContainerHeight
        return when {
    ...
    fun leadingButtonIconSizeFor(buttonHeight: Dp): Dp {
        return _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.iconSizeFor(buttonHeight)
    }
    ...
    /**
     * Create a default `leading` button that has the same visual as a Filled[com.deliveryhub.uberwatcher.material.Button]. To create a
     * `tonal`, `outlined`, or `elevated` version, the default value of [com.deliveryhub.uberwatcher.material.Button] params can be
     * passed in. For example, [com.deliveryhub.uberwatcher.material.ElevatedButton].
     *
     ...
     * @param colors [com.deliveryhub.uberwatcher.material.ButtonColors] that will be used to resolve the colors for this button in
     *   different states. See [com.deliveryhub.uberwatcher.material.ButtonDefaults.buttonColors].
     * @param elevation [com.deliveryhub.uberwatcher.material.ButtonElevation] used to resolve the elevation for this button in different
     *   states. This controls the size of the shadow below the button. See
     *   [com.deliveryhub.uberwatcher.material.ButtonElevation.shadowElevation].
    ...
    fun LeadingButton(
        ...
        colors: com.deliveryhub.uberwatcher.material.ButtonColors = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.buttonColors(),
        elevation: com.deliveryhub.uberwatcher.material.ButtonElevation? = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.buttonElevation(),
    ...
    /**
     * Creates a `trailing` button that has the same visual as a [com.deliveryhub.uberwatcher.material.Button].
     *
     * To create a `tonal`, `outlined`, or `elevated` version, the default value of [com.deliveryhub.uberwatcher.material.Button] params
     * can be passed in. For example, [com.deliveryhub.uberwatcher.material.ElevatedButton].
     *
     * The default text style for internal [Text] components will be set to [Typography.labelLarge].
     *
     * @param onClick called when the button is clicked
    ...
    /**
     * Creates a `trailing` button that has the same visual as a [com.deliveryhub.uberwatcher.material.Button]. When [checked] is updated
    ...
    /**
     * Create a tonal `leading` button that has the same visual as a Tonal[com.deliveryhub.uberwatcher.material.Button]. To create a
     * `filled`, `outlined`, or `elevated` version, the default value of [com.deliveryhub.uberwatcher.material.Button] params can be
     * passed in. For example, [com.deliveryhub.uberwatcher.material.ElevatedButton].
     *
     * The default text style for internal [Text] components will be set to [Typography.labelLarge].
     *
    ...
    fun TonalLeadingButton(
        ...
        enabled: Boolean = true,
        shapes: SplitButtonShapes = leadingButtonShapesFor(SmallContainerHeight),
        colors: com.deliveryhub.uberwatcher.material.ButtonColors = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.filledTonalButtonColors(),
        elevation: com.deliveryhub.uberwatcher.material.ButtonElevation? = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.filledTonalButtonElevation(),
        border: BorderStroke? = null,
        contentPadding: PaddingValues = leadingButtonContentPaddingFor(SmallContainerHeight),
        interactionSource: MutableInteractionSource? = null,
        content: @Composable RowScope.() -> Unit,
    ...
    /**
     * Creates a tonal `trailing` button that has the same visual as a [com.deliveryhub.uberwatcher.material.FilledTonalButton]. When
    ...
    /**
     * Create a elevated `leading` button that has the same visual as a [com.deliveryhub.uberwatcher.material.ElevatedButton]. To create
     * a `filled`, `outlined`, or `elevated` version, the default value of [com.deliveryhub.uberwatcher.material.Button] params can be
     * passed in. For example, [com.deliveryhub.uberwatcher.material.ElevatedButton].
     *
     * The default text style for internal [Text] components will be set to [Typography.labelLarge].
     *
    ...
    fun OutlinedLeadingButton(
        ...
        enabled: Boolean = true,
        shapes: SplitButtonShapes = leadingButtonShapesFor(SmallContainerHeight),
        colors: com.deliveryhub.uberwatcher.material.ButtonColors = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.outlinedButtonColors(),
        elevation: com.deliveryhub.uberwatcher.material.ButtonElevation? = null,
        border: BorderStroke? = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.outlinedButtonBorder(enabled),
        contentPadding: PaddingValues = leadingButtonContentPaddingFor(SmallContainerHeight),
        interactionSource: MutableInteractionSource? = null,
        content: @Composable RowScope.() -> Unit,
    ) {
    ...
    /**
     * Creates a outlined `trailing` button that has the same visual as a [com.deliveryhub.uberwatcher.material.OutlinedButton]. When
     * [checked] is updated from `false` to `true`, the buttons corners will morph to `full` by
     * default. Pressed shape and checked shape can be customized via [shapes] param.
     *
     * To create a `tonal`, `outlined`, or `elevated` version, the default value of [com.deliveryhub.uberwatcher.material.Button] params
    ...
    fun ElevatedLeadingButton(
        ...
        enabled: Boolean = true,
        shapes: SplitButtonShapes = leadingButtonShapesFor(SmallContainerHeight),
        colors: com.deliveryhub.uberwatcher.material.ButtonColors = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.elevatedButtonColors(),
        elevation: com.deliveryhub.uberwatcher.material.ButtonElevation? = _root_ide_package_.com.deliveryhub.uberwatcher.material.ButtonDefaults.elevatedButtonElevation(),
        border: BorderStroke? = null,
        contentPadding: PaddingValues = leadingButtonContentPaddingFor(SmallContainerHeight),
        interactionSource: MutableInteractionSource? = null,
        content: @Composable RowScope.() -> Unit,
    ...
    /**
     * Creates a elevated `trailing` button that has the same visual as a [com.deliveryhub.uberwatcher.material.ElevatedButton]. When
     * [checked] is updated from `false` to `true`, the buttons corners will morph to `full` by
     * default. Pressed shape and checked shape can be customized via [shapes] param.
     *
     * To create a `tonal`, `outlined`, or `elevated` version, the default value of [com.deliveryhub.uberwatcher.material.Button] params
