...
import com.deliveryhub.uberwatcher.material.internal.anchoredDraggable
import com.deliveryhub.uberwatcher.material.internal.draggableAnchors
...
fun BottomSheetScaffold(
    ...
    sheetContentColor: Color = contentColorFor(
        sheetContainerColor
    ),
    ...
    Surface(
        modifier =
            Modifier.widthIn(max = sheetMaxWidth)
                ...
                .then(nestedScroll)
                .draggableAnchors(state.anchoredDraggableState, orientation) { sheetSize,
                                                                               constraints ->
