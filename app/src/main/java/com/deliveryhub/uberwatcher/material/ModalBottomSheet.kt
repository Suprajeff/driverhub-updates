 ...
 *   the matching content color for [containerColor], or to the current [com.deliveryhub.uberwatcher.material.LocalContentColor] if
...
@Immutable
@ExperimentalMaterial3Api
class ModalBottomSheetProperties(val shouldDismissOnBackPress: Boolean = true) {
