...
import com.deliveryhub.uberwatcher.material.tokens.MenuTokens
...
fun DropdownMenu(
    ...
    DropdownMenu(
        ...
        modifier = modifier,
        offset = DpOffset(offset.x.value.dp, offset.y.value.dp),
        properties = properties,
        content = {
            // Wrap the content inside a Column with vertical scroll using scrollState
