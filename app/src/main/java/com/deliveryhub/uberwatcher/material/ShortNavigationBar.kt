...
import com.deliveryhub.uberwatcher.material.tokens.NavigationBarHorizontalItemTokens
import com.deliveryhub.uberwatcher.material.tokens.NavigationBarTokens
import com.deliveryhub.uberwatcher.material.tokens.NavigationBarVerticalItemTokens
 ...
 * - If the icon position is [com.deliveryhub.uberwatcher.material.NavigationItemIconPosition.Top] the icon will be displayed above the
 ...
 * - If the icon position is [com.deliveryhub.uberwatcher.material.NavigationItemIconPosition.Start] the icon will be displayed to the
 ...
 *   services.
 * @param iconPosition the [com.deliveryhub.uberwatcher.material.NavigationItemIconPosition] for the icon
 * @param colors [com.deliveryhub.uberwatcher.material.NavigationItemColors] that will be used to resolve the colors used for this item
...
object ShortNavigationBarDefaults {
    ...
    val contentColor: Color
        @Composable get() = contentColorFor(
            containerColor
        )
