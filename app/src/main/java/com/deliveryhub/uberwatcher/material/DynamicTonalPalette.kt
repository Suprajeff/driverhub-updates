...
internal fun dynamicTonalPalette(context: Context): TonalPalette =
    TonalPalette(
        ...
        neutral98 =
            ColorResourceHelper.getColor(context, R.color.system_neutral1_600)
                .setLuminance(98f),
        neutral96 =
            ColorResourceHelper.getColor(context, R.color.system_neutral1_600)
                .setLuminance(96f),
        ...
        neutralVariant100 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_0),
        neutralVariant99 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_10),
        neutralVariant98 =
        ...
        neutralVariant96 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(96f),
        neutralVariant95 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_50),
        neutralVariant94 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(94f),
        neutralVariant92 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(92f),
        neutralVariant90 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_100),
        neutralVariant87 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(87f),
        neutralVariant80 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_200),
        neutralVariant70 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_300),
        neutralVariant60 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_400),
        neutralVariant50 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_500),
        neutralVariant40 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600),
        neutralVariant30 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_700),
        neutralVariant24 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(24f),
        neutralVariant22 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(22f),
        neutralVariant20 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_800),
        neutralVariant17 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(17f),
        neutralVariant12 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(12f),
        neutralVariant10 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_900),
        neutralVariant6 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(6f),
        neutralVariant4 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_600)
                .setLuminance(4f),
        neutralVariant0 =
            ColorResourceHelper.getColor(context, R.color.system_neutral2_1000),
...
internal fun dynamicLightColorScheme34(context: Context) =
    lightColorScheme(
        ...
        onSecondary =
            ColorResourceHelper.getColor(context, R.color.system_on_secondary_light),
        secondaryContainer =
        ...
        onTertiary =
            ColorResourceHelper.getColor(context, R.color.system_on_tertiary_light),
        tertiaryContainer =
...
internal fun dynamicDarkColorScheme34(context: Context) =
    darkColorScheme(
        ...
        inversePrimary =
            ColorResourceHelper.getColor(context, R.color.system_primary_light),
        secondary = ColorResourceHelper.getColor(context, R.color.system_secondary_dark),
        onSecondary =
            ColorResourceHelper.getColor(context, R.color.system_on_secondary_dark),
        secondaryContainer =
        ...
        onBackground =
            ColorResourceHelper.getColor(context, R.color.system_on_background_dark),
        ...
        inverseSurface =
            ColorResourceHelper.getColor(context, R.color.system_surface_light),
        inverseOnSurface =
