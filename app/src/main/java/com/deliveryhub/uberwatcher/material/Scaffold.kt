...
import com.deliveryhub.uberwatcher.material.internal.MutableWindowInsets
 ...
 *
 * Simple example of a Scaffold with [com.deliveryhub.uberwatcher.material.TopAppBar] and [com.deliveryhub.uberwatcher.material.FloatingActionButton]:
 *
 ...
 * @param topBar top app bar of the screen, typically a [com.deliveryhub.uberwatcher.material.TopAppBar]
 * @param bottomBar bottom bar of the screen, typically a [com.deliveryhub.uberwatcher.material.NavigationBar]
 * @param snackbarHost component to host [Snackbar]s that are pushed to be shown via
 *   [SnackbarHostState.showSnackbar], typically a [SnackbarHost]
 * @param floatingActionButton Main action button of the screen, typically a [com.deliveryhub.uberwatcher.material.FloatingActionButton]
 * @param floatingActionButtonPosition position of the FAB on the screen. See [FabPosition].
 * @param containerColor the color used for the background of this scaffold. Use [Color.Transparent]
 *   to have no color.
 * @param contentColor the preferred color for content inside this scaffold. Defaults to either the
 *   matching content color for [containerColor], or to the current [com.deliveryhub.uberwatcher.material.LocalContentColor] if
 ...
 * @param fab the [com.deliveryhub.uberwatcher.material.FloatingActionButton] displayed on top of the [content], below the [snackbar] and
 *   above the [bottomBar]
 * @param bottomBar the content to place at the bottom of the [Scaffold], on top of the [content],
 *   typically a [com.deliveryhub.uberwatcher.material.NavigationBar].
 */
@Composable
...
/** The possible positions for a [com.deliveryhub.uberwatcher.material.FloatingActionButton] attached to a [Scaffold]. */
@kotlin.jvm.JvmInline
value class FabPosition internal constructor(@Suppress("unused") private val value: Int) {
    companion object {
        /**
         * Position FAB at the bottom of the screen at the start, above the [com.deliveryhub.uberwatcher.material.NavigationBar] (if it
         * exists)
         */
        val Start = FabPosition(0)

        /**
         * Position FAB at the bottom of the screen in the center, above the [com.deliveryhub.uberwatcher.material.NavigationBar] (if it
         * exists)
         */
        val Center = FabPosition(1)

        /**
         * Position FAB at the bottom of the screen at the end, above the [com.deliveryhub.uberwatcher.material.NavigationBar] (if it
         * exists)
         */
        val End = FabPosition(2)

        /**
         * Position FAB at the bottom of the screen at the end, overlaying the [com.deliveryhub.uberwatcher.material.NavigationBar] (if
         * it exists)
         */
...
/**
 * Placement information for a [com.deliveryhub.uberwatcher.material.FloatingActionButton] inside a [Scaffold].
 *
