...
import com.deliveryhub.uberwatcher.material.BadgedBox
import com.deliveryhub.uberwatcher.material.DrawerDefaults
import com.deliveryhub.uberwatcher.material.Icon
import com.deliveryhub.uberwatcher.material.LocalContentColor
import com.deliveryhub.uberwatcher.material.MaterialTheme
import com.deliveryhub.uberwatcher.material.NavigationBar
import com.deliveryhub.uberwatcher.material.NavigationBarDefaults
import com.deliveryhub.uberwatcher.material.NavigationBarItem
import com.deliveryhub.uberwatcher.material.NavigationBarItemColors
import com.deliveryhub.uberwatcher.material.NavigationBarItemDefaults
import com.deliveryhub.uberwatcher.material.NavigationDrawerItem
import com.deliveryhub.uberwatcher.material.NavigationDrawerItemColors
...
import com.deliveryhub.uberwatcher.material.NavigationRailDefaults
import com.deliveryhub.uberwatcher.material.NavigationRailItem
import com.deliveryhub.uberwatcher.material.NavigationRailItemColors
import com.deliveryhub.uberwatcher.material.NavigationRailItemDefaults
import com.deliveryhub.uberwatcher.material.PermanentDrawerSheet
    ...
    fun calculateFromAdaptiveInfo(adaptiveInfo: WindowAdaptiveInfo): NavigationSuiteType {
        return with(adaptiveInfo) {
            if (
                ...
                windowSizeClass.isHeightAtLeastBreakpoint(WindowSizeClass.Companion.HEIGHT_DP_MEDIUM_LOWER_BOUND)
            ) {
                NavigationSuiteType.NavigationBar
            } else if (
                windowSizeClass.isWidthAtLeastBreakpoint(WindowSizeClass.Companion.WIDTH_DP_MEDIUM_LOWER_BOUND)
            ) {
                NavigationSuiteType.NavigationRail
            } else {
                NavigationSuiteType.NavigationBar
